      ...
      <div className="container">
        ...
        <div className="row padding-20">
          <div className="col-xs-12">
            ...
            >
              {beautify.html(
                renderToString(<Link Icon="be-icon-pencil" text="edit" />)
              )}
            </SyntaxHighlighter>
          </div>
        </div>
        ...
        <div className="row padding-20">
          <div className="col-xs-12">
            ...
            >
              {beautify.html(
                renderToString(<Link Icon="be-icon-pencil" Blue text="edit" />)
              )}
            </SyntaxHighlighter>
          </div>
        </div>
        ...
        <div className="row padding-20">
          <div className="col-xs-12">
            ...
            >
              {beautify.html(
                renderToString(<Link Icon="be-icon-pencil" White text="edit" />)
              )}
            </SyntaxHighlighter>
          </div>
        </div>
