...
function Element(_ref) {
  ...
  var headingTypes = [types.HEADING, types.TITLE, types.SUBTITLE];
  ...
  if (headingTypes.indexOf(type) > -1) {
    var level = type === types.SUBTITLE ? _Heading.SUBTITLE_HEADING_LEVEL : _Heading.TITLE_HEADING_LEVEL;
  ...
  if (type === types.QUICK_REPLY) {
    return _react2.default.createElement(_QuickReply2.default, { elements: elements, onClick: onClick });
  }
