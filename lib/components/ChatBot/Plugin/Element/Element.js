...
function Element(_ref) {
  ...
  if (type === types.BUTTON) {
    return _react2.default.createElement(_Button2.default, { label: text, onClick: function onClick() {}, postback: postback });
  }
  ...
  if (type === types.QUICK_REPLY) {
    return _react2.default.createElement(_QuickReply2.default, { elements: elements, onSelect: function onSelect() {} });
  }
  if (Array.isArray(elements)) {
    return _react2.default.createElement(_ComposedElement2.default, { elements: elements });
  }
  return null;
}